...
struct IvanTurgenevBooks {
    static let bestWorks = [
        ...
        Book(title: "Rudin",
             ...
             url: URL(string: "https://books.google.com/books/content?id=YYtRDwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api")!),
        
        Book(title: "On the Eve",
             description: "No description available",
             url: URL(string: "https://books.google.com/books/content?id=9tJKAAAAYAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api")!),
        ...
        Book(title: "Fathers and Sons",
             ...
             url: URL(string: "https://books.google.com/books/content?id=AKlFPgAACAAJ&printsec=frontcover&img=1&zoom=1&source=gbs_api")!),
        ...
        Book(title: "Home of the Gentry",
             ...
             url: URL(string: "https://books.google.com/books/content?id=uiOiHCx7ANoC&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api")!),
        ...
        Book(title: "Spring Torrents",
             ...
             url: URL(string: "https://books.google.com/books/content?id=fGCyDwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api")!),

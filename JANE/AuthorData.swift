...
var allAuthorData: [Author]  = [
    Author(image: "Jane-Austen",
           imageCredit: """
    ...
    Author(image: "Harper-Lee",
           ...
           smallBio: """
                          ...
                          After graduation, Lee studied at Oxford University. She returned to the University of Alabama to study law but withdrew six months before graduation. She moved to New York in 1949 and worked as a reservations clerk for Eastern Air Lines and British Overseas Airways. While in New York, she wrote several essays and short stories, but none were published.
    ...
    Author(image: "Miguel-de-Cervantes",
           imageCredit: """
